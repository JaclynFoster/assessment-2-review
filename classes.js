...
class Animal {
    constructor(weightInLbs, isVertebrate, primaryColor) {
        this.weightInLbs = weightInLbs
        this.isVertebrate = isVertebrate
        this.primaryColor = primaryColor
    }
    incWeight(weight) {
   return this.weightInLbs += weight

    }
    printColor() {
        console.log("Animal Color:", this.primaryColor)
...
let animal1 = new Animal (50, true, "orange")
let animal2 = new Animal (300, false, "brown")

console.log("My Animals:", animal1, animal2)
...
animal1.incWeight(20)
animal2.incWeight(40)
console.log("New Weight:", animal1, animal2)
let animal1Color = animal1.printColor()
console.log(animal1Color)
