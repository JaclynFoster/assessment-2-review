...
//  of a function expresssion.
    ...
    const myFunctionExpression = function() {
        return "My function was invoked"
    }
...
const threeTimes = num => {
    return num + 50
}
let first = threeTimes(50)
console.log(first)
let second = threeTimes(100)
console.log(second)
let third = threeTimes(150)
console.log(third)
// 3.3
...
//  with each invocation having different arguments.
//  After your array is created, log it to the console.

let divideArr = [divide(3,5), divide(37,82), divide(43, 4)]
